...
\frame{
\frametitle{Sequential probability ratio test}
Sequential test for multinomial random variables: reduce it to a comparison of Bernoullis (\cite{weiss_sequential_1962})
\bit
...
\frametitle{Hash function PRNGs}
\bit
\item Efficient: based on fast, pre-existing hash function code. Some cryptographic hash primitives are even built into hardware (e.g. AES block cipher is on all Intel processors)
