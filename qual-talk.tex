...
\item \todo{take a quote from Marsaglia paper, saying that PRNGs with large state space are good enough for this}
\eit
\end{frame}
...
\item I will show
\bit
\item New tests for pseudorandomness
\item New PRNGs
\eit
\eit
}
...
\vspace{15pt}
PRNG based on the SHA256 hash function passes the tests described. \hyperlink{sha256_tests}{\beamerbutton{see appendix}}
\end{frame}
