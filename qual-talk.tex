...
\frame{
\frametitle{Sample uniformity with MT}

\bit
\item Generate samples using MT; compute p-values for increasing number of samples 
\item PIKK requires $n$ PRNs; sample\_by\_index requires only $k$ PRNs
\item No straightforward pattern in $p$-values from these two algorithms
\eit
